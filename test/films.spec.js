...
describe('Function "orderAlphabetically"', () => {
  ...
  it('should only return the title of the movies, each value should be a string', () => {
    expect(typeof orderAlphabetically([{
      title: 'aab'
    }])[0]).toBe('string');
  });
...
describe('Function "moviesAverageByCategory"', () => {
  ...
  it('should return the average score of 2 movies with score 7 each', () => expect(moviesAverageByCategory([{
    score: 7,
    genre: ['Drama']
  }, {
    score: 7,
  ...
  it('should be rounded to 2 decimals places', () => expect(moviesAverageByCategory([{
    score: 7,
    genre: ['Drama']
  }, {
    score: 6,
  ...
  it('should not take into consideration films of other category', () => expect(moviesAverageByCategory([{
    score: 5,
    genre: ['Drama']
  }, {
    score: 10,
  ...
  it('should return average even if one of the movies does not have score', () => expect(moviesAverageByCategory([{
    score: 5,
    genre: ['Action']
  }, {
    score: '',
